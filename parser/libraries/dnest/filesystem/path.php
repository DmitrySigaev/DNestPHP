...
define('DNEST_PATH_ISWIN', (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN'));
/** boolean True if a Mac based host */
define('DNEST_PATH_ISMAC', (strtoupper(substr(PHP_OS, 0, 3)) === 'MAC'));
...
if (!defined('DNEST_PATH_ROOT')) {
	/** string The root directory of the file system in native format */
	define('DNEST_PATH_ROOT', JPath::clean(DNEST_PATH_SITE));
}
